 ...
 */
  ...
  return (
    <div  className='bg-black relative overflow-hidden'>
      ...
      <div id='coresection' className='h-screen w-full flex justify-center relative py-10 px-5 z-10'>
        <div className='w-full flex flex-col justify-left h-full gap-2 '>
          <div className='flex flex-col w-full h-full place-items-left my-3 mx-10 lg:pl-40 md:pl-0 sm:pl-0'>
            <div className=''>
              <h1 className='font-sans md:tracking-wider mb-4 text-base md:text-lg lg:text-2xl'>Pilih Komoditas</h1>
