 ...
 */
  ...
  return (
    <div id='coresection' className='flex flex-wrap bg-black '>
      <div>
      ...
      <div className='h-screen w-full   lex justify-center relative py-10 px-5 mt-10'>
        <div className='w-full flex flex-col justify-left h-full gap-2  '>

          {/* <div className='w-full h-screen my-10 mx-10 border border-yellow-500'> */}
          <div className='flex flex-col w-full h-full place-items-left my-3 mx-10 pl-40 '>
            <div>
              <h1 className='font-sans md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl'>Pilih Komoditas</h1>
