...
import CoreSectionVertical from './CoreSectionVertical';
import CoreSectionHorizontal from './CoreSectionHorizontal';
 ...
 */
  ...
  return (
    <div  className='bg-black relative overflow-hidden'>
      ...
      {isMobile && <CoreSectionVertical />}
      {isTabletOrDesktop && <CoreSectionHorizontal />}
